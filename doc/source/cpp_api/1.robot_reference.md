...
permalink: /human-y1/robot_reference/
---
# 机器人主控服务
...
<table style="width: 100%; table-layout: fixed; border-collapse: collapse; text-align: left;">
  ...
  <tbody>
    ...
    <tr><td>参数说明</td><td><code>local_ip</code>：本地通信IP地址。用于后续通信身份绑定。</td></tr>
...
<table style="width: 100%; table-layout: fixed; border-collapse: collapse; text-align: left;">
  ...
  <tbody>
    <tr><td>函数名</td><td>GetSlamNavController</td></tr>
    <tr><td>函数声明</td><td><code>SlamNavController& GetSlamNavController();</code></td></tr>
    <tr><td>功能概述</td><td>获取 Slam Navigation 控制器对象。</td></tr>
    <tr><td>返回值</td><td>引用类型，用于 Slam Navigation 控制。</td></tr>
