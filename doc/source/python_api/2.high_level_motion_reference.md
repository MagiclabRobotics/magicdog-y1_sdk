...
permalink: /human-y1/python_high_level_motion_reference/
---
...
<table style="width: 100%; table-layout: fixed; border-collapse: collapse; text-align: left;">
  ...
  <tbody>
    <tr><td>函数名</td><td>set_walk_gait_id</td></tr>
    <tr><td>函数声明</td><td><code>Status set_walk_gait_id(WalkGaitId walk_gait_id)</code></td></tr>
...
<table style="width: 100%; table-layout: fixed; border-collapse: collapse; text-align: left;">
  ...
  <tbody>
    <tr><td>函数名</td><td>get_walk_gait_id</td></tr>
    <tr><td>函数声明</td><td><code>Status get_walk_gait_id()</code></td></tr>
    <tr><td>功能概述</td><td>获取当前行走步态 ID</td></tr>
    <tr><td>返回值</td><td><code>Status</code> 对象，包含当前行走步态信息</td></tr>
    <tr><td>备注</td><td>阻塞接口，获取当前行走步态</td></tr>
  </tbody>
</table>
...
<table style="width: 100%; table-layout: fixed; border-collapse: collapse; text-align: left;">
  ...
  <tbody>
    <tr><td>函数名</td><td>set_motion_id</td></tr>
    <tr><td>函数声明</td><td><code>Status set_motion_id(MotionId motion_id)</code></td></tr>
    <tr><td>功能概述</td><td>设置非行走动作 ID</td></tr>
    <tr><td>参数说明</td><td><code>motion_id</code>：动作枚举</td></tr>
    <tr><td>返回值</td><td><code>Status</code> 对象，<code>Status.code == ErrorCode.OK</code> 表示成功</td></tr>
  </tbody>
</table>
...
<table style="width: 100%; table-layout: fixed; border-collapse: collapse; text-align: left;">
  ...
  <tbody>
    <tr><td>函数名</td><td>get_motion_id</td></tr>
    <tr><td>函数声明</td><td><code>Status get_motion_id()</code></td></tr>
    <tr><td>功能概述</td><td>获取当前动作 ID</td></tr>
    <tr><td>返回值</td><td>返回 <code>(status, motion_id)</code> 元组；<code>status.code == ErrorCode.OK</code> 表示成功</td></tr>
